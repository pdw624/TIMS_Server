...
@TimsAttribute(attributeId = BrtAtCode.FTP_LIST_NOTIFICATION_REQUEST)
public class AtFtpListNotifyRequest extends AtData {
public static final int SIZE = 121;
	...
	public AtFtpListNotifyRequest() {
		attrId = BrtAtCode.FTP_LIST_NOTIFICATION_REQUEST;
		this.deviceId = "";
		this.reservationId = "";
