...
@TimsAttribute(attributeId = AtCode.POWER_CONTROL_RES)
public class AtPowerControlResponse extends AtData {
    ...
    public AtPowerControlResponse() {
        attrId = AtCode.POWER_CONTROL_RES;
        reserved = new byte[4];
    }
