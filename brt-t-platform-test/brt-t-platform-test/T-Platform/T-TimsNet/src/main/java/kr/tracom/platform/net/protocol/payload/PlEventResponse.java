...
public class PlEventResponse extends TimsPayload {
	...
	public PlEventResponse() {
		PayloadName = "Event-Response";
		OpCode = PlCode.OP_EVENT_RES;

		attrCount = 0;
		resultList = new ArrayList<>();
	}

	public void addAttributeResult(AtResult atResult) {
