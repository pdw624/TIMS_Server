...
public class RouteNodeItem1 implements BaseModel {
    public static final int SIZE = 12;

    private String routeId;
    private short count;
    private List<RouteNodeItem2> list;

    public RouteNodeItem1() {
        list = new ArrayList<>();
    }

    public void addList(RouteNodeItem2 item) {
        this.list.add(item);
    ...
    @Override
    public int getSize() {
        return SIZE + (RouteNodeItem2.SIZE * list.size());
    }
    ...
    public void decode(ByteHelper byteHelper) {
        ...
        for(int i=0; i<loop; i++) {
            RouteNodeItem2 item = new RouteNodeItem2();
